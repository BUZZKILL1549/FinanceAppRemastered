...
class InsuranceClass:
    ...
    def insurance(self) -> None:
        ...
        # Scrollbar
        vScrlbar = ttk.Scrollbar(mainFrame, orient = HORIZONTAL, command = mainCanvas.xview)
        vScrlbar.pack(side = TOP, fill = X)

        # Configure canvas
        mainCanvas.configure(xscrollcommand = vScrlbar.set)
